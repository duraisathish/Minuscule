...
public class EU_User {
	...
	public void EUUserLogout()
	{
		...
		WebDriverWait wait4 = new WebDriverWait(driver, 60);
		wait4.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"userNav-arrow\"]")));

		WebElement logout = driver.findElement(By.xpath("//*[@id=\"userNav-arrow\"]"));
		logout.click();

		WebDriverWait wait5 = new WebDriverWait(driver, 60);
		wait5.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"userNav-menuItems\"]/a[5]")));

		WebElement click = driver.findElement(By.xpath("//*[@id=\"userNav-menuItems\"]/a[5]"));
		click.click();
	...
	public void ThirdLevelLogin()
	{
		...
		wait6.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"topButtonRow\"]/input[4]")));	
	...
	public void ThirdLevelLogout()
	{
		...
		WebDriverWait wait3 = new WebDriverWait(driver, 60);
		wait3.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"oneHeader\"]/div[1]/div[2]/a")));

		WebElement logout = driver.findElement(By.xpath("//*[@id=\"oneHeader\"]/div[1]/div[2]/a"));
		logout.click();	
